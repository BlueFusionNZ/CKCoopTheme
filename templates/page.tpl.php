...
<!--      <div class="hidden-sm hidden-md hidden-lg"> <?php //col-sm-3 col-sm-push-9 clearfix ?>
      </div>-->
<div class="main-container container">
  <!--<div class="row">-->
    <?php if (!empty($page['highlighted'])): ?>
        <div class="col-sm-12 hidden-xs"><?php print render($page['highlighted']); ?></div>
    <?php endif; ?>
    ...
    <section class="main-content"<?php //floatright print $content_column_class; ?>>
      ...
      <aside class="sidebar-second" role="complementary">
        <?php print render($page['side_cart']); ?>
